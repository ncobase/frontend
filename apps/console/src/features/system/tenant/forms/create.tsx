...
export const CreateTenantForm = ({ onSubmit, control, setValue, errors }) => {
      ...
      fields: [
        {
          ...
          description: t('tenant.title_hint', 'Title displayed in browser tab')
        },
        {
        ...
        },
        {
          ...
          description: t('tenant.logo_alt_hint', 'Alternative text for accessibility')
        }
      ]
    },
    {
