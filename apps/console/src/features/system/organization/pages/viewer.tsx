...
import { OrgViewerForms } from '../forms/viewer';

import { useLayoutContext } from '@/components/layout';

export const OrgViewerPage = ({ viewMode, record: initialRecord, handleView }) => {
  ...
  if (mode === 'modal') {
    return <OrgViewerForms record={record} />;
  }
