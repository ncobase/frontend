    ...
    <Controller
      ...
      render={({ field }) => (
        <SelectField
          ...
          options={[
            { label: t('space.types.private'), value: 'private' },
            { label: t('space.types.public'), value: 'public' },
            { label: t('space.types.internal'), value: 'internal' },
            { label: t('space.types.external'), value: 'external' },
            { label: t('space.types.other'), value: 'other' }
          ]}
          {...field}
        />
      )}
