...
import { SpaceViewerForm } from '../forms/viewer';

import { useLayoutContext } from '@/components/layout';

export const SpaceViewerPage = ({ viewMode, record: initialRecord, handleView }) => {
  ...
  if (mode === 'modal') {
    return <SpaceViewerForm record={record} />;
  }
